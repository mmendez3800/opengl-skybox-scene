...
int main(int argc, char *argv[])
{
	...
	glutCreateWindow("OpenGL Skybox Scene"); //Open window and set window title
	...
	glDisable(GL_NORMALIZE);                                     //Auto normalize surface normals
	...
	glutMotionFunc(Window::mouseDragCallback);
