...
{
    Vector3 b(m[0]+a.m[0], m[1]+a.m[1], m[2]+a.m[2]);
...
{
	float m0 = m[1] * a.m[2] - m[2] * a.m[1];
	float m1 = m[2] * a.m[0] - m[0] * a.m[2];
	float m2 = m[0] * a.m[1] - m[1] * a.m[0];
    Vector3 b(m0, m1, m2);
...
Vector3 Vector3::normalize(void)
{
    ...
    Vector3 b(m[0] / mag, m[1] / mag, m[2] / mag);
